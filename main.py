...
#prepare data
input_dir = "Path to your dataset directory"  # Update this path to your dataset directory
...
print('{}% of sample were classified correctly'.format(str(score * 100)))


pickle.dump(best_estimator, open('model_image_class.p', 'wb'))